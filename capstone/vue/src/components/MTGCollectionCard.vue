...
import scryfallService from '../services/ScryfallService';
  ...
  export default {
    ...
    created() {
      collectionApiService.getCollectionById(this.collectionID.toString()).then((response) => {
        this.currentCollection = response.data;
      });
      this.currentCollection.forEach(card => {
        scryfallService.getSingleCardById(card.card_api_id)
